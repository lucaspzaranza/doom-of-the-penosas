...
public abstract class ControllerBackup : MonoBehaviour
{
    ...
    [SerializeField] protected MonoBehaviour _menuUITranslatorMonoBehaviour;
    protected IMenuTranslator _menuUITranslator;
    ...
    public virtual void OnEnable()
    {
        ...
        if (_menuUITranslatorMonoBehaviour != null)
            _menuUITranslator = _menuUITranslatorMonoBehaviour as IMenuTranslator;
    }
