...
public class StageController : ControllerUnit
{
    ...
    public override void Setup()
    {
        ...
        RideArmorEvents.OnRideArmorEquipped += HandleOnRideArmorEquipped;
        RideArmorEvents.OnRideArmorChangedRequired += HandleOnRideArmorChangedRequired;

        EnemyEvents.OnBossDefeated += HandleOnBossDefeated;
    }
    ...
    public void HandleOnRideArmorEquipped(IRideArmor rideArmor)
    {
