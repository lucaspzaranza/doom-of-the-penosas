...
public class FallFromPlatform : MonoBehaviour, IPlatform
{
    ...
    private List<IPlayerCharacter> _playersOnPlatform = new List<IPlayerCharacter>();
    ...
    public void AddPlayerOnPlatform(IPlayerCharacter player)
    {
    ...
    private void OnCollisionEnter2D(Collision2D other)
    {
        ...
        {
            var player = other.gameObject.GetComponent<IPlayerCharacter>();
