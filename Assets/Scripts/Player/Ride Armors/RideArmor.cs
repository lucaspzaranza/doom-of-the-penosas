...
public abstract class RideArmor : DamageableObject, IRideArmor
{
    public event Action<int> OnRideArmorLifeChanged;
    ...
    public bool Required
    {
        ...
        {
            _required = value;
            RideArmorEvents.OnRideArmorChangedRequired?.Invoke(_type, value);
        }
    }
    ...
    public virtual void Shoot()
    {
        if(_continuousTimeCounter >= PlayerConsts.RideArmorMachineGunInterval)
        {
            ...
            newBullet.GetComponent<IProjectile>().Speed = _player.ShotSpeed * _direction;
        }
        else
    ...
    public virtual void Equip(IPlayerCharacter player, IPlayerController playerController)
    {
        ...
        RideArmorEvents.OnRideArmorEquipped?.Invoke(this);
    }
    ...
    protected void SetEquippedPlayerActivation(IPlayerCharacter player, bool value)
    {
